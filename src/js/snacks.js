(function(){
  ...
  .then(function() {
    ...
    //populate snacks
    const snacksCol = document.getElementById("populate-snacks");
    db.collection("snacks").onSnapshot(function(querySnapshot) {
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-two">
                        ...
                        <div class="desc">
                        <button type="button" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5" onclick="addToCart('snacks','${menu.data().item_id}')"><i class="fa fa-shopping-cart"></i>  Add To Cart</button>
                        </div>
                            <div class="clear"></div>
                    </div>
                </div>
