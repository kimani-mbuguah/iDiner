(function(){
    ...
    //populate breakfast
    const snacksCol = document.getElementById("populate-breakfast");
    db.collection("breakfast").onSnapshot(function(querySnapshot) {
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-two">
                        ...
                        <div class="desc">
                        <button type="button" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5" onclick="addToCart('breakfast','${menu.data().item_id}')"><i class="fa fa-shopping-cart"></i>  Add To Cart</button>
                        </div>
                            <div class="clear"></div>
                    </div>
                </div>
